...
alias cdo='cd ~/Projects/db-dxp-owner-backend'
alias cdf='cd ~/Projects/db-api-product-features'
alias cdi='cd ~/Projects/db-api-outer-irp'
alias cda='cd ~/Projects/db-api-assets'
alias cde='cd ~/Projects/db-api-aemp'
